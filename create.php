...
$file_name = basename($_FILES['gambar']['name']); // Pakai nama asli file
...
// Cek apakah file sudah ada, jika iya tambahkan angka untuk mencegah duplikasi
$target_file = $target_dir . $file_name;
$counter = 1;
while (file_exists($target_file)) {
    $file_name = pathinfo($_FILES['gambar']['name'], PATHINFO_FILENAME) . "_$counter." . $file_ext;
    $target_file = $target_dir . $file_name;
    $counter++;
}
